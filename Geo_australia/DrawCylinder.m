function [Cylinder,EndPlate1,EndPlate2] = DrawCylinder(X1,X2,r,n,plateColor,closed,lines)
%
...
set(Cylinder,'FaceColor','interp','FaceAlpha',0.5,'EdgeColor','w','EdgeAlpha',0.3,'LineWidth',0.1);

if closed==1
    set(EndPlate1,'FaceColor',plateColor,'FaceAlpha',0.5,'EdgeColor','w','EdgeAlpha',0.2,'LineWidth',0.1);
    set(EndPlate2,'FaceColor',plateColor,'FaceAlpha',0.5,'EdgeColor','w','EdgeAlpha',0.2,'LineWidth',0.1);
else
    EndPlate1=[];
    EndPlate2=[];
end
